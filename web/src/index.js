...
function makeThumbnailURL(mxc) {
  return `${HOMESERVER_URL}/_matrix/media/r0/thumbnail/${mxc.substring(
    6
  ...
  >
    <div class="sticker">
      ${iconOverride
        ...
        : html`
            <img
              src=${makeThumbnailURL(pack.stickers[0].info.thumbnail_url)}
...
const Sticker = ({ content, send }) => html`
  <div class="sticker" onClick=${send} data-sticker-id=${content.id}>
    <img
      data-src=${makeThumbnailURL(content.info.thumbnail_url)}
      alt=${content.body}
      title=${content.body}
    />
  </div>
